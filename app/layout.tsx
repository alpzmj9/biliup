...
import { SetStateAction, useCallback, useEffect, useLayoutEffect, useMemo, useState } from 'react'
          ...
          <Sider>
            ...
            >
              ...
              <Nav.Footer collapseButton={true}>
                {/* {footer(mode, setMode,systemTheme)} */}
...
const ThemeButton: React.FC<ThemeProps> = props => {
  // console.log("systhem: "+props.systemTheme)
  ...
  switch (props.mode) {
    ...
    case 'dark':
      // console.log("success, mode: "+props.mode)
      return (
        <Button
          onClick={switchMode}
          theme="borderless"
